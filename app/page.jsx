...
const ConnectAID_App = () => {
  ...
  return (
    <main className='bg-[#f7f7f7]'>
      ...
      <section className='mt-10 py-10 px-4 sm:px-6 md:px-8 lg:px-12'>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8'>
          {/* Support Card */}
          <div 
            className={`rounded-xl text-center shadow-md py-5 px-4 transition-all duration-300 ease-in-out h-full ${isHoveredSupport ? 'bg-teal-600 shadow-xl' : 'bg-white'}`}
          ...
          > 
            ...
            <h1 className={`mb-4 text-2xl md:text-3xl font-bold tracking-wide transition-colors duration-300 ${isHoveredSupport ? 'text-white' : 'text-black'}`}> 
              Support
            </h1>
            <p className={`mb-3 text-sm md:text-base px-3 transition-colors duration-300 ${isHoveredSupport ? 'text-white' : 'text-slate-700'}`}>
          ...
          {/* Education Card */}
          <div 
            className={`rounded-xl text-center shadow-md py-5 px-4 transition-all duration-300 ease-in-out h-full ${isHoveredEducation ? 'bg-teal-600 shadow-xl' : 'bg-white'}`}
          ...
          > 
            ...
            <h1 className={`mb-4 text-2xl md:text-3xl font-bold tracking-wide transition-colors duration-300 ${isHoveredEducation ? 'text-white' : 'text-black'}`}> 
              Education
            </h1>
            <p className={`mb-3 text-sm md:text-base px-3 transition-colors duration-300 ${isHoveredEducation ? 'text-white' : 'text-slate-700'}`}>
          ...
          {/* Request Card */}
          <div 
            className={`rounded-xl text-center shadow-md py-5 px-4 transition-all duration-300 ease-in-out h-full ${isHoveredRequest ? 'bg-teal-600 shadow-xl' : 'bg-white'}`}
          ...
          > 
            ...
            <h1 className={`mb-4 text-2xl md:text-3xl font-bold tracking-wide transition-colors duration-300 ${isHoveredRequest ? 'text-white' : 'text-black'}`}> 
              Request
            </h1>
            <p className={`mb-3 text-sm md:text-base px-3 transition-colors duration-300 ${isHoveredRequest ? 'text-white' : 'text-slate-700'}`}>
          ...
          {/* Donations Card */}
          <div 
            className={`rounded-xl text-center shadow-md py-5 px-4 transition-all duration-300 ease-in-out h-full ${isHoveredDonations ? 'bg-teal-600 shadow-xl' : 'bg-white'}`}
          ...
          > 
            ...
            <h1 className={`mb-4 text-2xl md:text-3xl font-bold tracking-wide transition-colors duration-300 ${isHoveredDonations ? 'text-white' : 'text-black'}`}> 
              Donations
            </h1>
            <p className={`mb-3 text-sm md:text-base px-3 transition-colors duration-300 ${isHoveredDonations ? 'text-white' : 'text-slate-700'}`}>
