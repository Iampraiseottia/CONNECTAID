      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          >
            ...
            <h1
              className={`mb-4 text-2xl md:text-3xl font-bold tracking-wide transition-colors duration-200 
              ${isHoveredMedical ? "text-white" : "text-black"}`}
            >
              Medicals
            </h1>
            <p
              className={`mb-3 text-sm md:text-base px-3 transition-colors duration-200 
              ${isHoveredMedical ? "text-white" : "text-slate-700"}`}
            >
              Donating funds for medical 🏥 care supports sick individuals,
              providing essential treatments, medications, and resources to
              improve their health and well-being.
            </p>
            <Link
              href="/donation"
              className={`mb-3 text-sm md:text-base px-3 transition-colors duration-200 flex justify-center items-center mt-4 
              ${isHoveredMedical ? "text-white" : "text-teal-600"}`}
            >
              <span className="font-semibold text-xl tracking-wide hover:text-[21px]">
                Read More{" "}
              </span>
          ...
          >
            ...
            >
              Make a meaningful difference in the lives of those in need. Your
              generosity provides essential resources, support, and hope,
              fostering positive change in communities and individuals.
            </p>
            <Link
              href="/donation"
              className={`mb-3 text-sm md:text-base px-3 transition-colors duration-200 flex justify-center items-center mt-4 
          ...
          >
            ...
            >
              Social service promotes community well-being by addressing needs,
              providing support, and empowering individuals through programs
              that enhance quality of life and foster social connection.
            </p>
            <Link
              href="/donation"
              className={`mb-3 text-sm md:text-base px-3 transition-colors duration-200 flex justify-center items-center mt-4 
