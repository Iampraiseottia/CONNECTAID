          ...
          {donations.map((donation) => (
            <div key={donation.id} className="flex flex-col h-full bg-white rounded-lg shadow-md overflow-hidden">
              <div className="relative">
                ...
                <div className="absolute top-4 left-4 px-3 py-1 rounded-md text-white" style={{ backgroundColor: '#00856F' }}>
              ...
              <div className="flex-1 p-5 leading-8 ">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
                  <div 
                    ...
                    style={{ width: `${donation.progress}%`, backgroundColor: '#00856F' }}
                  ></div>
                </div>
                ...
                <div className="flex justify-between items-center mb-5">
                  <div className="flex gap-5">
                    <div>
                      <p className="text-gray-700 font-medium">{donation.totalAmt}</p>
                      <h4 className="text-sm text-gray-600">Goals</h4>
                    </div>
                    <div>
                      <p className="text-gray-700 font-medium">{donation.raisedAmt}</p>
