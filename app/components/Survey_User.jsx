...
//               <div>
//                 <label className="block text-sm font-medium text-gray-700 mb-2">
//                   What types of donations do you prefer? (Select all that apply)
//                 </label>
//                 <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
//                   {[
//                     "Direct financial support to individuals",
//                     "Organizational/NGO donations",
//                     "Emergency relief",
...
//               <div>
//                 <label className="block text-sm font-medium text-gray-700 mb-2">
//                   How would you like to receive updates? (Select all that apply)
//                 </label>
//                 <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
//                   {[
//                     "Email newsletters",
...
//               <div>
//                 <label className="block text-sm font-medium text-gray-700 mb-2">
//                   Do you require tax receipts for your donations?
//                 </label>
