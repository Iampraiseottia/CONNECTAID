    ...
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-2xl md:text-4xl font-bold sm:-ml-[190px] sm:-mr-[130px] text-gray-900 dark:text-gray-900 py-2 ">
            Together, we changed lives 📈 and create lasting memories 🔥!
          </h2>
        </motion.div>
