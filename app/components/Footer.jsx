        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/donation" className="text-gray-300 hover:text-yellow-400 transition-colors">
                  Latest Projects
                </Link>
              </li>
              <li>
                <Link href="/donate-payment" className="text-gray-300 hover:text-yellow-400 transition-colors">
                  Change Lives Now
                </Link> 
              </li>
              <li>
              ...
              <li>
                <Link href="/testimonials" className="text-gray-300 hover:text-yellow-400 transition-colors">
                  Our Testimonials
                </Link>
              </li>
            </ul>
          ...
          {/* Get Support */}
          <div>
            <h4 className="text-teal-500 text-xl font-semibold mb-6">Our Work</h4>
            <ul className="space-y-4">
              <li>
                <Link href="/upcoming-event-details-1" className="text-gray-300 hover:text-yellow-400 transition-colors">
                  Upcoming Events
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/past-event-details-1" className="text-gray-300 hover:text-yellow-400 transition-colors">
                  Past Events
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/faqs" className="text-gray-300 hover:text-yellow-400 transition-colors">
            ...
            <ul className="space-y-6">
              <li>
                <div className="flex gap-4">
                  <Link href="/donation-details-1" className="flex-shrink-0 w-20 h-20 hover:scale-105 ease-in-out duration-200 cursor-pointer relative overflow-hidden rounded-md">
                    <Image
                  ...
                  <div>
                    ...
                    <h4 className="text-white font-medium hover:text-teal-500 transition-colors">
                      <Link href="/donation-details-1">Feed the hungry and less privilege and needy. </Link>
                    </h4>
                  </div>
                </div>
              </li>
              <li>
                <div className="flex gap-4">
                <Link href="/donation-details-2" className="flex-shrink-0 w-20 h-20 hover:scale-105 ease-in-out duration-200 cursor-pointer relative overflow-hidden rounded-md">
                    <Image
                  ...
                  <div>
                    ...
                    <h4 className="text-white font-medium hover:text-teal-500 transition-colors">
                      <Link href="/donation-details-2">Provide quality and good education to children </Link>
                    </h4>
                  </div> 
                </div>
              </li>
