          ...
          <div className="flex justify-between items-center">
            <div className="flex-1">
              <h4 className="text-xl font-bold capitalize mb-1">
                <Link href="/volunteer-details" className="hover:text-emerald-600 transition duration-300">
                  {name}
                </Link>
              </h4>
            ...
            <div className="relative">
              ...
              {showSocial && (
                <div className="absolute right-0 flex bg-white shadow-md rounded-md z-10"> 
                  <a href="#" className="p-2 hover:text-emerald-600 transition duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
