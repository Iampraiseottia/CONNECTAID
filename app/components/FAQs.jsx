  ...
  const handleToggle = (clickedIndex) => {
    detailsRef.forEach((refs, index) => {
      if (
        index !== clickedIndex &&
        refs.current &&
        refs.current.hasAttribute("open")
      ) {
  ...
  return (
    <main className="mt-28 sm:mx-4 md:mx-8 lg:mx-20 xl:mx-40 pb-20 px-5">
      ...
      >
        <div className="w-full lg:w-2/4 mb-10 md:mb-0 -mt-20 md:mt-5 faq1 transition-all ease-in-out">
          ...
          >
            ...
            <p className="mt-2 ml-4 sm:ml-11 text-[18px]">
              ...
              contributions are making a difference. For monetary donations,
              you'll receive impact reports showing exactly what your donation
              has funded.
            </p>
          </details>
          ...
          >
            ...
            <p className="mt-2 ml-4 sm:ml-11 text-[18px]">
              Yes, we prioritize the security of your data. We employ bank-level
              encryption (256-bit SSL) for all transactions and personal
              information. We never store complete credit card information on
              our servers. Our platform undergoes regular security audits and
              penetration testing by independent cybersecurity firms. We're also
              compliant with GDPR, CCPA, and other privacy regulations to ensure
        ...
        <div
          className="flex justify-center lg:-mt-36 lg:justify-start -mt-28 md:ml-10 faq3 lg:ml-20 xl:ml-36"
          ref={faqImgRef}
