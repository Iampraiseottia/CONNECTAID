      ...
      <div className="max-w-4xl mx-auto mt-10">
        ...
        <div className="bg-white shadow-md rounded-lg p-6 mb-8">
          <p className="text-gray-600 mb-6">
            ...
            campaigns that align with your interests so you can impact those in needs life 🙏.
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 mt-3 ">
              ...
              <div>
                ...
                <input
                  ...
                  ${formData.fullName && formData.fullName.trim().length >= 7 
                    ...
                    : 'border-gray-500 focus:ring-teal-500 focus:outline-none'}
                  `} 
              ...
              <div>
                ...
                <select
                  ...
                  } border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-teal-500`} 
                >
