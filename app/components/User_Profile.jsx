...
// import { Camera, Edit, Save, X, Mail, Phone, MapPin, Calendar, CheckSquare, XCircle, BadgeCheck } from "lucide-react";
...
//     preferredCategories: ["Education", "Healthcare", "Basic Needs"],
...
//   // Stats data
//   const stats = [
//     { label: "Total Donated", value: `$${userData.donationHistory.totalDonated.toLocaleString()}` },
//     { label: "Campaigns Supported", value: userData.donationHistory.campaignsSupported },
//     { label: "Last Donation", value: new Date(userData.donationHistory.lastDonation).toLocaleDateString() },
//   ];
...
//               <h3 className="font-semibold text-slate-700 mb-3">Donation Summary</h3>
...
//           {/* Verification Status */}
//           <div className="bg-white rounded-lg shadow-md p-6 mb-6">
//             <h3 className="text-xl font-semibold text-slate-800 mb-4">Verification Status</h3>
...
//                   <div>
//                     <h4 className="font-medium text-teal-700">Your account is verified</h4>
...
//                   <div>
//                     <h4 className="font-medium text-amber-700">Verification pending</h4>
...
//           <div className="bg-white rounded-lg shadow-md p-6">
//             <h3 className="text-xl font-semibold text-slate-800 mb-4">Preferred Categories</h3>
//             <p className="text-gray-600 mb-4">
//               Select categories you're interested in supporting. We'll highlight relevant campaigns for you.
//             </p>
//             <div className="flex flex-wrap gap-2">
//               {["Education", "Healthcare", "Basic Needs", "Environment", "Animal Welfare", "Housing", "Food Security", "Emergency Relief", "Arts & Culture"].map((category) => (
//                 <label 
//                   key={category} 
