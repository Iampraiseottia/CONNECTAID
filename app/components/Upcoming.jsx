    ...
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <motion.div 
          ...
          <span className="inline-block text-emerald-600 text-3xl font-semibold mb-6 sm:text-5xl">Upcoming Events</span>
          <h2 className="text-2xl md:text-4xl font-bold sm:-ml-[150px] sm:-mr-[130px]">Join us to make a difference 🔥, one event at a time!</h2>
        </motion.div>
