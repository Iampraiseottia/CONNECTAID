          ...
          >
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 mb-5 text-[18px]">
                Here at ConnectAID, we are the Best 💯 Charity Organization out
                there. Our commitment to excellence drives us to deliver
                impactful solutions for those in need. We prioritize efficiency,
                ensuring that every donation reaches its intended purpose
                swiftly ✅.
              </p>
              <p className="text-gray-600 mb-5 text-[18px]">
                Reliability 🔥 is at the core of our mission. We maintain
                transparency and accountability 🔥, building trust with our
                donors and beneficiaries ✅. Together, we create a brighter
                future 🌟, one act of kindness at a time.
              </p>
              <p className="text-gray-600 text-[18px]">
                Our dedicated team works tirelessly ❤️‍🔥 to identify, verify and
                address pressing community and personal issues. By leveraging
                resources effectively, we maximize the impact of our programs,
                fostering sustainable change and uplifting lives in the
            ...
            <div className="space-y-6 mt-2">
              ...
              <div className="mt-8">
                <Link
                  href="/about"
                  className="bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-8 rounded-md inline-block font-medium transition duration-300"
                >
                  Read More
                </Link>
              </div>
