        ...
        <div className="flex flex-col lg:flex-row justify-center gap-6">
          ...
          <div className="w-full lg:w-2/3 xl:w-7/12">
            <Swiper
              ...
              pagination={{ 
                clickable: true,
                bulletActiveClass: 'swiper-pagination-bullet-active !bg-teal-500 !important',
                  ...
                  <div className="absolute bottom-5 left-0 p-3 sm:p-4 md:p-6 bg-gradient-to-t from-black/80 to-transparent w-full">
                    <div className="flex gap-3 sm:gap-5 mb-2 sm:mb-3">
                      <div className="flex items-center gap-1 sm:gap-2">
                        <FontAwesomeIcon icon={faGift} className="text-yellow-500 text-xs sm:text-base" />
                        <p className="text-white text-xs sm:text-sm md:text-base">Kindness</p>
                      </div>
                      <div className="flex items-center gap-1 sm:gap-2">
                        <FontAwesomeIcon icon={faMapPin} className="text-teal-500 text-xs sm:text-base" />
                        <p className="text-white text-xs sm:text-sm md:text-base">Africa</p>
                      </div>
                    </div>
                    <div>
              ...
              <SwiperSlide>
                <div className="relative h-full">
                  ...
                  <div className="absolute bottom-5 left-0 p-3 sm:p-4 md:p-6 bg-gradient-to-t from-black/80 to-transparent w-full">
                    <div className="flex gap-3 sm:gap-5 mb-2 sm:mb-3">
                      <div className="flex items-center gap-1 sm:gap-2">
                        <FontAwesomeIcon icon={faGraduationCap} className="text-yellow-500 text-xs sm:text-base" />
                        <p className="text-white text-xs sm:text-sm md:text-base">Education</p>
                      </div>
                      <div className="flex items-center gap-1 sm:gap-2">
                        <FontAwesomeIcon icon={faMapPin} className="text-teal-500 text-xs sm:text-base" />
                        <p className="text-white text-xs sm:text-sm md:text-base">Asia</p>
                      </div>
                    </div>
                    <div>
                      <h4 className="text-white text-base sm:text-lg md:text-xl lg:text-2xl font-semibold max-w-lg">
              ...
              <SwiperSlide>
                <div className="relative h-full">
                  ...
                  <div className="absolute bottom-3 left-0 p-3 sm:p-4 md:p-6 bg-gradient-to-t from-black/80 to-transparent w-full">
                    <div className="flex gap-3 sm:gap-5 mb-2 sm:mb-3">
                      <div className="flex items-center gap-1 sm:gap-2">
                        <FontAwesomeIcon icon={faBottleWater} className="text-yellow-500 text-xs sm:text-base" />
                        <p className="text-white text-xs sm:text-sm md:text-base">Water</p>
                      </div> 
                      <div className="flex items-center gap-1 sm:gap-2">
                        <FontAwesomeIcon icon={faMapPin} className="text-teal-500 text-xs sm:text-base" />
                        <p className="text-white text-xs sm:text-sm md:text-base">Africa</p>
                    ...
                    <div>
                      <h4 className="text-white text-base sm:text-lg md:text-xl lg:text-2xl font-semibold max-w-lg">
                        Donate To Give A Community Gain and Good Clean Drinking Water 🚰
                      </h4>
                    </div>
                  </div>
                </div>
              ...
              <SwiperSlide>
                <div className="relative h-full">
                  ...
                  <div className="absolute bottom-5 left-0 p-3 sm:p-4 md:p-6 bg-gradient-to-t from-black/80 to-transparent w-full">
                    <div className="flex gap-3 sm:gap-5 mb-2 sm:mb-3">
                      <div className="flex items-center gap-1 sm:gap-2">
                        <FontAwesomeIcon icon={faHome} className="text-yellow-500 text-xs sm:text-base" />
                        <p className="text-white text-xs sm:text-sm md:text-base">Housing</p>
                      </div>
                      <div className="flex items-center gap-1 sm:gap-2">
                        <FontAwesomeIcon icon={faMapPin} className="text-teal-500 text-xs sm:text-base" />
                        <p className="text-white text-xs sm:text-sm md:text-base">America</p>
                      </div>
                    </div>
                    <div>
                      <h4 className="text-white text-base sm:text-lg md:text-xl lg:text-2xl font-semibold max-w-lg">
              ...
              <SwiperSlide>
                <div className="relative h-full">
                  ...
                  <div className="absolute bottom-5 left-0 p-3 sm:p-4 md:p-6 bg-gradient-to-t from-black/80 to-transparent w-full">
                    <div className="flex gap-3 sm:gap-5 mb-2 sm:mb-3">
                      <div className="flex items-center gap-1 sm:gap-2">
                        <FontAwesomeIcon icon={faFaceSmile} className="text-yellow-500 text-xs sm:text-base" />
                        <p className="text-white text-xs sm:text-sm md:text-base">Happiness</p>
                      </div>
                      <div className="flex items-center gap-1 sm:gap-2">
                        <FontAwesomeIcon icon={faMapPin} className="text-teal-500 text-xs sm:text-base" />
                        <p className="text-white text-xs sm:text-sm md:text-base">Africa</p>
                    ...
                    <div>
                      <h4 className="text-white text-base sm:text-lg md:text-xl lg:text-2xl font-semibold max-w-lg">
                        Put A Beautiful Smile 😊 On The Faces Of Amazing Children 
                      </h4>
                    </div>
                  </div>
                </div>
          ...
          <div className="w-full lg:w-[40%] lg:ml-[100px] z-10 xl:w-3/12 bg-[#00815D] text-white shadow-lg mt-6 lg:mt-0">
            <div className="p-4 sm:p-5 md:p-6 leading-8"> 
              ...
              <div className={`${activeTab === 'tab-section-one' ? 'block' : 'hidden'}`}>
                ...
                <h4 className="text-lg sm:text-2xl font-semibold mb-1 sm:mb-6 sm:mt-4 text-center">The Universal Hands-free lighting Solution</h4>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2 mb-3 sm:mb-7 sm:mt-5">
                  <div className="bg-yellow-400 h-2 mt-2 rounded-full relative" style={{ width: '65%' }}> 
                    <span className="absolute -right-3 -top-6 text-xl font-semibold">65%</span> 
                  </div>
                </div>
                <div className="flex justify-between items-center mt-3 sm:mt-4">
                  ...
                  <div className="bg-yellow-500 w-12 h-12 rounded-full p-2 sm:p-2 text-center cursor-pointer">
                    <FontAwesomeIcon icon={faShare} className="text-white text-xs text-center sm:text-xl" />
                  </div> 
                </div>
              </div>
