    ...
    <main className='mb-20'>
      <motion.div 
        ...
        <div className="w-full text-center">
          <h3 className='text-center text-teal-700 font-bold tracking-wide text-3xl sm:text-5xl'>Upcoming Events </h3>
          <p className='text-center text-xl mt-3 tracking-tight font-normal mb-10 leading-8 sm:mx-32 mx-3'>Join us for an unforgettable experience filled with inspiration, community connection, and impactful moments that empower change, celebrate togetherness, and create lasting memories for everyone involved in our upcoming events!</p>
        </div>
      </motion.div>
            ...
            <div className="relative rounded-lg overflow-hidden shadow-lg transition-all duration-500 swiper-slide-content" > 
              ...
              <div className="absolute top-6 right-6 z-10">
                <div className="relative">
                  <div className="sm:w-20 sm:h-16 h-12 w-12 rounded bg-[#fbbf24] sm:rounded-lg"> 
                  </div>
          ...
          <SwiperSlide>
            <div className="relative rounded-lg overflow-hidden shadow-lg transition-all duration-500 swiper-slide-content">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
                ...
                <div className="mt-2">
                  <p className="text-white/90 text-sm">
                    Learn new skills and expand your knowledge with our expert-led workshops.
                  </p>
                </div>
              </div>
          ...
          <SwiperSlide>
            <div className="relative rounded-lg overflow-hidden shadow-lg transition-all duration-500 swiper-slide-content">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
                ...
                <div className="mt-2">
                  <p className="text-white/90 text-sm">
                    Join us for an evening of celebration and support for our ongoing initiatives.
                  </p>
                </div>
              </div>
