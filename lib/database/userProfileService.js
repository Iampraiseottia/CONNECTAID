...
export class UserProfileService {
  ...
  static async createUserProfile(profileData) {
    ...
    INSERT INTO user_profiles (
      ...
      home_address, city, state_province_region, country, bio, interests, selfie_file
  ...
  static validateProfileData(profileData) {
    ...
    if (profileData.selfieFile) {
      if (typeof profileData.selfieFile !== "string") {
        throw new Error("Selfie file must be a valid string");
      }

      if (!profileData.selfieFile.startsWith("data:image/")) {
        throw new Error("Selfie file must be a valid image format");
      }
    }
